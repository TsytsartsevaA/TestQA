...
Сценарий: _0601 подготовительный (добавление картинок)
	...
	//И Я устанавливаю в базу расширение из файла "C:\Users\gribs\Documents\GitLab\test\Features_IRP\Additional\IRP_TestExtension.cfe"
...
Сценарий: _0602 проверка добавления картинки
	...
	И Пауза 5
	И я выбираю файл "C:\Users\gribs\Downloads\Files\itempicture1.png"
	И Пауза 5
