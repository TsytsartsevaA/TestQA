...
Функционал: Проверка формы элемента спровочника Организации
...
Сценарий: проверка доступности вкладок Налоги и Валюты в справочнике Организаций
	...
	* Снятие галочки Наша компания и проверка отсутствия на форме Валют и Налогов	
		...
		И элемент формы "GroupCurrencies" существует и невидим на форме
		И элемент формы "GroupTaxes" существует и невидим на форме
